...
const Quiz = ({ questions, keyForRemount }) => {
  ...
  return (
    <div className="flex items-start justify-center h-screen">
      <div className="w-1/2 p-8 bg-white shadow-lg rounded-md mt-1">
        {showScore ? (
          <div>
            <h2 className="text-3xl font-bold mb-4">Tu Puntuación: {score} / {selectedQuestions.length}</h2>
            <button
          ...
          <div>
            <h2 className="text-2xl font-bold mb-2">Pregunta {currentQuestionIndex + 1}:</h2>
